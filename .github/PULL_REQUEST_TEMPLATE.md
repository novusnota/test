<!--
  1. Could this affect a user’s behavior? Remember that developers are users too.
  2. Did anything change on the surface, such as:
     - configuration values
     - external APIs: new functions, changes in the behavior of existing ones, etc.?
  3. Is there something you want to highlight to the devs using this tech?
  ...
  doing so according to their suggestions.

  If docs won't be written, please explain why.
-->
<!-- If or when the request is opened, uncomment the next line: -->
